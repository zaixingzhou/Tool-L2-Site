...
namespace LANDIS_II_Site
{
    public partial class FormMain : Form
    {
        ...
        private void MenuRun_Click(object sender, EventArgs e)
        {
            ...
            string InputExtension = cbExtensionOption.Text;
            int ext_succession = cbExtensionOption.SelectedIndex;

            if (ext_succession == 0)
            {
                InputExtension = "\\PnET-Succession";
            }
            if (ext_succession == 1)
            {
                InputExtension = "\\PnET-CN-Succession";
            }

            string InputDirectory = @".\Input";
            InputDirectory = InputDirectory + InputExtension;
